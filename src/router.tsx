...
import AffiliatePortalPage from "./pages/affiliate";
import AffiliateRegisterPage from "./pages/affiliate/register";
  ...
  [
    {
      ...
      children: [
        ...
        {
          path: "/affiliate",
          element: <AffiliatePortalPage />,
          handle: {
            title: "Cổng cán bộ Hội LHPN",
            noFooter: false,
          },
        },
        {
